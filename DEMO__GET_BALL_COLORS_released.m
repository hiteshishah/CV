function DEMO__GET_BALL_COLORS_released( fn )
%
...
INTERACTIVE = 0;
    ...
    if ( nargin < 1 )
        fn = 'BALLS_Four_RGBY_5239__small.JPG';
    end
...
%     bg_indices  = sub2ind( size(im_klab), round(y_bg), round(x_bg) );
    ...
    subplot(2,2,4);
    imagesc( class_im );
    title('NOISE CLEANED VERSION... you should add a title here ', 'FontSize', 20, 'FontWeight', 'bold' );
